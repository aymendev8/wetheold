 ...
 */
final class Version20230316182338 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_wishlist (id INT AUTO_INCREMENT NOT NULL, wishlist_id INT NOT NULL, INDEX IDX_575140A6FB8E54CD (wishlist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE product_wishlist_articles (product_wishlist_id INT NOT NULL, articles_id INT NOT NULL, INDEX IDX_BB1797CF1EBAF6CC (articles_id), INDEX IDX_BB1797CF57A1CAD2 (product_wishlist_id), PRIMARY KEY(product_wishlist_id, articles_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE wishlist (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nb_articles INT NOT NULL, UNIQUE INDEX UNIQ_9CE12A31A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
